...
def load_ztf_data(filepath="/media/biswajit/drive/ZTF_20190512/ZTF_MSIP_MODEL64/ZTF_MSIP_NONIaMODEL0-0001_PHOT.FITS",
...
def load_PLAsTiCC_data(phot_df_file_path="/media/biswajit/drive/PLAsTiCC_data/training_set.csv",
                       meta_df_file_path="/media/biswajit/drive/PLAsTiCC_data/training_set_metadata.csv"):
